...
<head>
    ...
    <?php include '../estilos/style_form_compra.php'; ?>
</head>
<body>
    <header>
    ...
    <div class="container">
        <div class="cont">
            <h2>Formulário de compra de produto</h2><br>
            <p>logo abaixo você irá encontrar um formulário para poder comprar um produto em nosso site,  por favor preencha os campos com o que e pedido.</p>
                <form action="../php/vendacontroller.php" method="post" id="cadastrar">
                <div id="form">
                    <label for="">Código do produto:</label><br>
                    <input type="number" name="cod" class="form_input" reduired><br><br>
                    ...
                    <input type="submit" name="acao" class="button_form" value="Comprar">
                </div>
            </form><br>
            <h2>Formulário para cancelar compra</h2><br>
            <p>logo abaixo você irá encontrar um formulário para poder cancelar uma compra realizada em nosso site,  por favor preencha os campos com o que e pedido.</p>
            <form action="../php/vendacontroller.php" method="post" id="cadastrar">
                <div id="form">
                    <label>Código do pedido:</label><br>
                    <input type="number" class="form_input" name="cod" required><br><br>
                    <input type="submit" class="button_form" name="acao" value="Cancelar">
                </div>
            </form>
        </div>
    </div>
